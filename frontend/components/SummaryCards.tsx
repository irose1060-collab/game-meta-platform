    ...
    return (
      <section className="container">
        <div className="section-head">
          <h2>TODAY&apos;S META</h2>
          <div className="line" />
          <small>DB 통계 로딩 중</small>
        </div>
        <div className="notice-board-empty">
          홈 메타 정보를 PostgreSQL DB에서 불러오는 중입니다...
        </div>
      </section>
    );
  }
    ...
    return (
      <section className="container">
        ...
        <p className="error-message">
          {error || "오늘의 메타 정보를 표시할 수 없습니다."}
        </p>
        <button className="btn btn-gold" onClick={fetchHomeMeta}>
          다시 불러오기
        </button>
      </section>
    );
  ...
  return (
    <section className="container">
      <div className="section-head">
        <h2>TODAY&apos;S META</h2>
        <div className="line" />
        <small>PostgreSQL DB + Riot Data Dragon 기반</small>
      </div>

      <div className="cards">
        <div className="card" onClick={() => router.push("/champions")}>
          <div className="card-tag">DB Hot Pick</div>
          <h3>오늘의 인기 챔피언</h3>
          <div className="body">
            <div className="champ-row">
              ...
              <div>
                ...
                <div style={{ color: "var(--text-dim)", fontSize: 12 }}>
                  {meta.hotChampion.position} · {meta.hotChampion.source || "DB DATA"}
                </div>
              </div>
            </div>
            ...
            <div className="champ-stats">
              <div>
                <small>승률</small>
                <b className="stat-win">{meta.hotChampion.winRate}%</b>
              </div>
              <div>
                <small>픽률</small>
                <b>{meta.hotChampion.pickRate}%</b>
              </div>
              <div>
                <small>밴률</small>
                <b>{meta.hotChampion.banRate}%</b>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="card" onClick={(event) => event.stopPropagation()}>
          <div className="card-tag">Latest DB Patch</div>
          <h3>최근 패치 요약</h3>
          <div className="body">
        ...
        <div className="card" onClick={() => router.push("/statistics")}>
          <div className="card-tag">DB Meta Insight</div>
          <h3>메타 데이터 상태</h3>
          <div className="body">
            <div className="meter">
              <div className="label">분석 픽</div>
              <div className="bar">
                <i style={{ width: `${meta.teamCompSummary.apRatio}%` }} />
              </div>
              <div className="v">{meta.teamCompSummary.apStatus}</div>
            </div>
            <div className="meter">
              <div className="label">챔피언 풀</div>
              <div className="bar">
                <i style={{ width: `${meta.teamCompSummary.ccScore}%` }} />
              </div>
              <div className="v">{meta.teamCompSummary.ccStatus}</div>
            </div>
            <div className="meter">
              <div className="label">대표 승률</div>
              <div className="bar">
                <i style={{ width: `${meta.teamCompSummary.expectedWinRate}%` }} />
              </div>
              <div className="v">{meta.teamCompSummary.expectedWinRate}%</div>
            </div>
        ...
        <div className="card" onClick={() => router.push("/statistics")}>
          ...
          <div className="card-tag">DB Summary</div>
          <h3>메타 요약 피드백</h3>
          <div className="body">
